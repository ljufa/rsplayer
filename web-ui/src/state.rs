...
impl AppState {
    ...
    pub fn dispatch(&mut self, event: StateChangeEvent) {
        match event {
            ...
            StateChangeEvent::MetadataSongScanned(info) | StateChangeEvent::MetadataSongScanFinished(info) => {
            ...
            ev @ (StateChangeEvent::NotificationSuccess(_) | StateChangeEvent::NotificationError(_)) => {
