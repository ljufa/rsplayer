...
`de.rsplayer.app.yml` is a DRAFT metadata file for https://gitlab.com/fdroid/fdroiddata
(`metadata/de.rsplayer.app.yml`). Listing texts and the icon live in
...
- Verify locally: `fdroid readmeta && fdroid rewritemeta de.rsplayer.app && fdroid build -v -l de.rsplayer.app`.
